...
export default function Header({ services, lastUpdated }: HeaderProps) {
  ...
  return (
    <header className="border-b border-subtle bg-surface/70 backdrop-blur-sm sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        <div className="flex items-center justify-between flex-wrap gap-4">
          <div>
            <h1 className="text-2xl font-bold text-foreground flex items-center gap-3">
              <svg className="w-8 h-8 text-accent-cyan" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="text-right hidden sm:block">
              ...
              <div className="text-xs text-muted-strong">
                Updated {formatRelativeTime(lastUpdated, 'Never')}
              </div>
            </div>
          </div>
        </div>
